      ...
      <div className="max-w-5xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative">
        ...
        <div className="hidden lg:block space-y-10 animate-in slide-in-from-bottom duration-700">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-bold text-slate-400">24/7 Gate Verification</span>
            </div>
            <h1 className="text-6xl font-black text-slate-900 leading-[1.1] tracking-tighter">
              KSAC Digital <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-teal-600 to-emerald-700">GatePass</span> System.
            </h1>
            <p className="text-xl text-slate-500 font-medium leading-relaxed max-w-md">
              Tamper-proof digital gatepasses for KIIT Student Activity Center sessions, society practices, and verified hostel in-time extensions.
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 gap-8">
            <div className="space-y-2">
              ...
              <p className="text-xs font-black text-slate-400 uppercase tracking-widest">Tamper-Proof Logs</p>
            </div>
            <div className="space-y-2">
              <p className="text-3xl font-black text-slate-800">24/7</p>
              <p className="text-xs font-black text-slate-400 uppercase tracking-widest">Anytime Clearances</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white p-12 rounded-[3rem] shadow-2xl border border-slate-100 ring-1 ring-slate-200/50 relative animate-in zoom-in duration-700">
          <div className="space-y-2 mb-10 text-center lg:text-left">
            ...
            <p className="text-slate-500 font-medium text-sm">Sign in with your campus credentials.</p>
          </div>

          <form onSubmit={handleLogin} className="space-y-6">
            <div className="space-y-2">
              <label className="text-[10px] font-black text-slate-400 uppercase tracking-[0.2em] ml-1">Campus Email</label>
              <input
                type="email"
